        ...
        return (
          <Wrapper
            ...
            onDrop={ev => {
              ...
              if (
                node.__typename === CONTAINER_TYPES.CONTAINER &&
                dataTransfered.__typename === CONTAINER_TYPES.GRID
              ) {
              ...
              if (
                node.__typename === CONTAINER_TYPES.GRID &&
                dataTransfered.__typename === CONTAINER_TYPES.ELEMENT
              ) {
                if (!node.elements) {
                  node.elements = [];
                }
          ...
          >
            ...
            {childKeys.map((key, index) => {
              ...
              const span = getColSpan(childNode.__typename, childKeys.length);
